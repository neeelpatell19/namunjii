    ...
    const timeout = setTimeout(() => {
      ...
      filtered = filtered.filter((item) => {
        ...
        if (priceRange.min !== 0 || priceRange.max !== 50000) {
          console.log(
            `Product: ${item.ProductName}, Price: ${price}, Range: ${minPrice}-${maxPrice}, InRange: ${isInRange}`
          );
        }
        return isInRange;
      });
      ...
      if (value) {
        filtered = filtered.filter(
          (item) =>
            ...
            (item.designerName &&
              item.designerName.toLowerCase().includes(value))
        );
      }
      ...
      if (filterValue) {
        filtered = filtered.filter(
          (item) =>
            ...
            (item.designerName &&
              item.designerName.toLowerCase().includes(filterValue))
        );
      }
  ...
  return (
    <div className="MainContainer marginTop50 paddingBottom50 newRouteSectionPadding AllProductsPage">
      <div className="PaddingTop">
        <div className="Container">
          ...
          >
            ...
            <p className="text-center">
              Discover a curated collection of products from our diverse
              designers, each offering unique styles and quality craftsmanship.
            </p>
          </div>
          {/* Animated Search Bar */}
        </div>
          ...
          <div className="Container">
            <div className="AllProductsFilterHeaderFlexContainer">
              ...
              <div className="AnimatedButtonContainer desktop-only">
                <span className="ProductsCount" title="Products shown">
        ...
        <div className="FiltersShowConta"></div>
        ...
        <div className="Container marginTop50">
          <Row gutter={[12, 12]}>
            ...
            <Col lg={24}>
              <div
                className={`marginTop50 fade-grid${
                  fade ? " fade" : ""
                } AdjustRowOnMobile`}
              >
                              ...
                              <div className="CommonFlexGap">
                                ...
                                <div className="ProductPrize">
                                  {item.sale ? (
                                    (() => {
                                      const original =
                                        Number(item.basePricing) || 0;
                                      const discounted = Math.round(
                                        original * (1 - DISCOUNT_PERCENT / 100)
                                      );
                                      return (
                                    ...
                                    <p className="text-center smallFont">
                                      ₹&nbsp;
                                      {item.basePricing?.toLocaleString(
                                        "en-IN"
                                      )}
                                    </p>
                                  )}
