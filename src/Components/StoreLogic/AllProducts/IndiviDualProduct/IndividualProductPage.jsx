...
const IndividualProductPage = () => {
  useEffect(() => {
    if (window.fbq) window.fbq("track", "IndividualProductPageView");
  }, []);
  ...
  const Images = [
    ...
    {
      image:
        "https://images.unsplash.com/photo-1609505849320-29530bcb2d26?q=80&w=1064&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      image:
        "https://images.unsplash.com/photo-1608312149553-d31a9cbc5224?q=80&w=1064&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ];
  ...
  const product = designer?.DesignerProducts.find(
              ...
              items={[
                {
                  key: "1",
                  label: "Description",
                  children: <div>{product?.ProductBrief}</div>,
                },
                {
                  key: "2",
                  label: "Shipping",
                  children: (
                    <div>
                      <p>
                        Shipping within India: 3-7 business days.
                        <br />
