                ...
                <div className="rf-footer__inner Container marginTop50">
                    ...
                    <div className="rf-footer__brand">
                        ...
                        <div className="rf-footer__social">
                            <a href="#" aria-label="Instagram" className="rf-footer__social-btn">
                                {/* Instagram SVG */}
                                <svg viewBox="0 0 24 24" className="rf-footer__icon" aria-hidden="true">
                            ...
                            <a href="#" aria-label="Facebook" className="rf-footer__social-btn">
                                {/* Facebook SVG */}
                                <svg viewBox="0 0 24 24" className="rf-footer__icon" aria-hidden="true">
                            ...
                            <a href="#" aria-label="LinkedIn" className="rf-footer__social-btn">
                                {/* LinkedIn SVG */}
                                <svg viewBox="0 0 24 24" className="rf-footer__icon" aria-hidden="true">
                    ...
                    <div className="rf-footer__col">
                        ...
                        >
                            ...
                            />
                            <button className='CommonBtn'><span>Contact Us</span></button>
                        </form>
                    </div>
                </div>
            </footer>
