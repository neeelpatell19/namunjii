        ...
        <>
            <div className='DesignersListContainer marginTop50 PaddingTop'>
                <div className='FlexContainerWrapper'>
                    <div className='DesignersListHeader'>
                        <h2>Namunjii Designers List</h2>
                    </div>
                    <div className='DesignersListBody'>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Commodi expedita saepe unde qui numquam inventore aperiam laudantium earum perspiciatis quas.</p>
                    </div>
                </div>
