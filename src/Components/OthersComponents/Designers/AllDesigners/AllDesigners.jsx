            ...
            <div className="PaddingTop">
                ...
                <div className="Container">
                    <div className="DesignersPageContainer FlexContainerWrapper">
                        ...
                        <div>
                            <p>At Namunjii, we celebrate designers who stay true to their identity.
                                We provide visibility through curated offline spaces and a strong online presence.
                                More than a marketplace, we are a stage for authentic talent to rise.</p>
                            <div className="AnimatedButtonContainer">
                                <button className="AnimatedLineButton">View All Designers</button>
                            </div>
                        </div>
                    </div>
                    <div className="AnimatedDesignersCarousalContainer marginTop50 PaddingTop">
                        <div>
                            <div className="CarousalContainer maxWidth800">
                                <Swiper slidesPerView={1} spaceBetween={50} autoplay={{
                                    delay: 2000,
                                    disableOnInteraction: false,
                                }} loop={true} speed={800} modules={[Pagination, Autoplay]} className="mySwiper">
                                    {DesignerImagesData.map((designerData) => (
                                        <SwiperSlide key={designerData.id}>
                                            <div className="GridImagesContainer">
                                                {designerData.image.map((imageUrl, index) => (
                                                    <div key={index}>
                                                        <img src={imageUrl} alt={`Designer ${designerData.id} - Image ${index + 1}`} />
                                                    </div>
                                                ))}
                                            </div>
                                        </SwiperSlide>
                        ...
                        <div>
                            <div className="maxWidth800" style={{margin: "0 auto"}}>
                                <h3 className="text-center">
                                    Namunjii empowers designers to rise authentically—offering visibility through curated offline spaces and a strong online presence, creating a stage where unique voices, true craftsmanship, and timeless creativity find their audience.</h3>
                            </div>
                            <div
                                ref={parallaxRef}
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <div className="WomenShoppingIcon">
                                        <img src="https://s3.ap-south-1.amazonaws.com/prepseed/prod/ldoc/media/WomenShoppingIcon.png" alt="" />
                                    </div>
                                    <div className="AnimatedButtonContainer">
                                        <div>
                    ...
                    <div className="BrandMarketingTemplateContainer marginTop50">
                        <div className="LeftPadding100px AttachmentContainerImageContent maxWidth800">
                            <div>
                                <h2 style={{ color: "white" }}>Crafting diamond-shaped love stories time after time.</h2>
                                <br />
                                <p style={{ color: "white" }}>Indulge in the opulence of handcrafted necklaces, bracelets, earrings, and rings, each a masterpiece in its own right. Immerse yourself in the sparkle of meticulously selected gemstones and precious metals, expertly fashioned to create pieces that transcend trends and stand the test of time.</p>
                            </div>
                        </div>
                    </div>
                    <DesignersList />
