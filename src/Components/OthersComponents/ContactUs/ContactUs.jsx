...
const ContactUs = () => {
  useEffect(() => {
    if (window.fbq) window.fbq("track", "ContactUsPageView");
  }, []);
    ...
    <div className="MainContainer marginTop50 paddingBottom50">
      <div className="PaddingTop ">
        <div className="breadCrumbContainer Container marginBottom20 marginTop20">
          <img
            src="https://s3.ap-south-1.amazonaws.com/prepseed/prod/ldoc/media/WebsiteIdentityIcon.png"
            alt=""
          />
            ...
            <Row gutter={[30, 30]}>
              <Col lg={10} md={24} xs={24}>
                <div className="ContactUsImageContainer h-100">
                  <img
                    src="https://cdn.prod.website-files.com/678ca1173be404b47f58be4e/67b417101b1fdd30ab7eb316_contact-image.jpg"
                    alt=""
                  />
                </div>
              </Col>
